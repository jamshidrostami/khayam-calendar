...
public class EventRecurrence {
    ...
    public JalaliTime      startDate;     // set by setStartDate(), not parse()
    ...
    public void setStartDate(JalaliTime date) {
        startDate = date;
    }
    ...
    public static int day2TimeDay(int day)
    {
        switch (day)
        {
            ...
            case TU:
                return JalaliTime.TUESDAY;
            case WE:
                return JalaliTime.WEDNESDAY;
            case TH:
                return JalaliTime.THURSDAY;
            case FR:
                return JalaliTime.FRIDAY;
            case SA:
    ...
    public boolean equals(Object obj) {
        ...
        return  (startDate == null ?
                        er.startDate == null : JalaliTime.compare(startDate, er.startDate) == 0) &&
                freq == er.freq &&
        ...
        @Override public int parsePart(String value, EventRecurrence er) {
            if (VALIDATE_UNTIL) {
                try {
                	...
                	JalaliTime until = new JalaliTime();
                    until.parse(value);
