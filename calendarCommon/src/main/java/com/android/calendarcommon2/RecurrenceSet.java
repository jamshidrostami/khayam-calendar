...
public class RecurrenceSet {
    ...
    public static long[] parseRecurrenceDates(String recurrence)
        ...
        String tz = JalaliTime.TIMEZONE_UTC;
    ...
    public static boolean populateContentValues(ICalendar.Component component,
        ...
        try {
            ...
            JalaliTime start = new JalaliTime(tzidParam == null ? JalaliTime.TIMEZONE_UTC : tzid);
            ...
            if (allDay) {
                start.timezone = JalaliTime.TIMEZONE_UTC;
            }
    ...
    public static boolean populateComponent(Cursor cursor,
        ...
        JalaliTime dtstartTime = null;
        if (!TextUtils.isEmpty(tzid)) {
            if (!allDay) {
                dtstartProp.addParameter(new ICalendar.Parameter("TZID", tzid));
            }
            dtstartTime = new JalaliTime(tzid);
        } else {
            // use the "floating" timezone
            dtstartTime = new JalaliTime(JalaliTime.TIMEZONE_UTC);
        }
...
public static boolean populateComponent(ContentValues values,
    ...
    */
    ...
    private static String computeDuration(JalaliTime start,
                                          ICalendar.Component component) {
        ...
        JalaliTime end = new JalaliTime(endTzid);
