...
import com.yeksefr.khayam.alerts.AlertReceiver;
import com.yeksefr.khayam.widget.KhayamAppWidgetProvider;
...
public class GeneralPreferences extends PreferenceFragment implements
    ...
    static final String SHARED_PREFS_NAME_NO_BACKUP = "com.yeksefr.khayam_preferences_no_backup";
...
//    public static final String KEY_WEEK_START_DAY = "preferences_week_start_day";
    ...
    public static final String KEY_WIDGET_THEME = "preferences_widget_theme";
...
//        mWeekStart = (ListPreference) preferenceScreen.findPreference(KEY_WEEK_START_DAY);
        ...
        mWidgetTheme = (ListPreference) preferenceScreen.findPreference(KEY_WIDGET_THEME);
        mHomeTZ = preferenceScreen.findPreference(KEY_HOME_TZ);
//        mWeekStart.setSummary(mWeekStart.getEntry());
        mDefaultReminder.setSummary(mDefaultReminder.getEntry());
        mWidgetTheme.setSummary(mWidgetTheme.getEntry());
        ...
        if (!prefs.getBoolean(KEY_HOME_TZ_ENABLED, false)) {
            mTimeZoneId = prefs.getString(KEY_HOME_TZ, JalaliTime.getCurrentTimezone());
        }
...
//        mWeekStart.setOnPreferenceChangeListener(listener);
        ...
        mWidgetTheme.setOnPreferenceChangeListener(listener);
...
//            mWeekStart.setSummary(mWeekStart.getEntry());
            ...
            mDefaultReminder.setSummary(mDefaultReminder.getEntry());
        } else if (preference == mWidgetTheme) {
        	mWidgetTheme.setValue((String) newValue);
        	mWidgetTheme.setSummary(mWidgetTheme.getEntry());
        	
        	getActivity().sendBroadcast(new Intent(KhayamAppWidgetProvider.ACTION_REFRESH));
