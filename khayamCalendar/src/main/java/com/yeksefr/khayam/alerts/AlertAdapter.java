...
public class AlertAdapter extends ResourceCursorAdapter {
    ...
    public static void updateView(Context context, View view, String eventName, String location,
        ...
        CustomTextView titleView = (CustomTextView) view.findViewById(R.id.event_title);
        CustomTextView whenView = (CustomTextView) view.findViewById(R.id.when);
        CustomTextView whereView = (CustomTextView) view.findViewById(R.id.where);
        if (mFirstTime) {
        ...
        if (allDay) {
            flags = JalaliDateUtils.FORMAT_UTC | JalaliDateUtils.FORMAT_SHOW_WEEKDAY |
            		JalaliDateUtils.FORMAT_SHOW_DATE;
