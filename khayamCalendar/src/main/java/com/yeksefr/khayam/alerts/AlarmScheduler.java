...
public class AlarmScheduler {
    ...
    private static final long EVENT_LOOKAHEAD_WINDOW_MS = JalaliDateUtils.WEEK_IN_MILLIS;
    private static final long MAX_ALARM_ELAPSED_MS = JalaliDateUtils.DAY_IN_MILLIS;
    ...
    private static Cursor queryUpcomingEvents(Context context, ContentResolver contentResolver,
        ...
        ContentUris.appendId(uriBuilder, localStartMin - JalaliDateUtils.DAY_IN_MILLIS);
        ContentUris.appendId(uriBuilder, localStartMax + JalaliDateUtils.DAY_IN_MILLIS);
                    ...
                    if (startTimes != null) {
                        for (Long startTime : startTimes) {
                            long alarmTime = startTime -
                                    reminderMinutes * JalaliDateUtils.MINUTE_IN_MILLIS;
