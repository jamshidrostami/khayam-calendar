...
public class CreateEventDialogFragment extends DialogFragment implements TextWatcher {
    ...
    private CustomTextView mCalendarName;
    private CustomTextView mAccountName;
    ...
    public CreateEventDialogFragment(JalaliTime day) {
        setDay(day);
    }

    public void setDay(JalaliTime day) {
//    	mDateString = day.format(EVENT_DATE_FORMAT);
    ...
    public void onAttach(Activity activity) {
    	...
    	int flags = JalaliDateUtils.FORMAT_SHOW_DATE | JalaliDateUtils.FORMAT_SHOW_YEAR
                ...
                ;
        mDateString = JalaliDateUtils.formatDateTime(activity, mDateInMillis, flags);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mCalendarName = (CustomTextView) view.findViewById(R.id.calendar_name);
        mAccountName = (CustomTextView) view.findViewById(R.id.account_name);

        mEventTitle = (EditText) view.findViewById(R.id.event_title);
        mEventTitle.addTextChangedListener(this);

        mDate = (CustomTextView) view.findViewById(R.id.event_day);
        if (mDateString != null) {
                    ...
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            mController.sendEventRelatedEventWithExtraWithTitleWithCalendarId(this,
                                    ...
                                    mDateInMillis + JalaliDateUtils.DAY_IN_MILLIS, 0, 0,
    ...
    private void createAllDayEvent() {
        ...
        mModel.mEnd = mDateInMillis + JalaliDateUtils.DAY_IN_MILLIS;
