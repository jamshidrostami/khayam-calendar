...
package com.yeksefr.khayam.event;
...
import com.yeksefr.khayam.CalendarEventModel;
import com.yeksefr.khayam.CustomTextView;
import com.yeksefr.khayam.EmailAddressAdapter;
import com.yeksefr.khayam.EventInfoFragment;
import com.yeksefr.khayam.EventRecurrenceFormatter;
import com.yeksefr.khayam.GeneralPreferences;
import com.yeksefr.khayam.JalaliDateUtils;
import com.yeksefr.khayam.JalaliTime;
import com.yeksefr.khayam.RecipientAdapter;
import com.yeksefr.khayam.Utils;
import com.yeksefr.khayam.CalendarEventModel.Attendee;
import com.yeksefr.khayam.CalendarEventModel.ReminderEntry;
import com.yeksefr.khayam.event.EditEventHelper.EditDoneRunnable;
import com.yeksefr.khayam.recurrencepicker.RecurrencePickerDialog;
...
public class EditEventView implements View.OnClickListener, DialogInterface.OnCancelListener,
    ...
    CustomTextView mLoadingMessage;
    ...
    View mTimezoneRow;
    CustomTextView mStartTimeHome;
    CustomTextView mStartDateHome;
    CustomTextView mEndTimeHome;
    CustomTextView mEndDateHome;
    ...
    CustomTextView mWhenView;
    CustomTextView mTimezoneTextView;
    CustomTextView mTimezoneLabel;
    ...
    private JalaliTime mStartTime;
    private JalaliTime mEndTime;
    ...
    private class TimeListener implements OnTimeSetListener {
        ...
        public void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute) {
        	...
        	JalaliTime startTime = mStartTime;
        	JalaliTime endTime = mEndTime;
    ...
    private class TimeClickListener implements View.OnClickListener {
        private JalaliTime mTime;

        public TimeClickListener(JalaliTime time) {
            mTime = time;
        }
...
////            }
//            
//            final TimeListener listener = new TimeListener(v);
//            showTimePickerDialog(mTime.hour, mTime.minute, listener);
//        }
//    }
    ...
    private class DateListener implements OnDateSetListener {
        ...
        public void onDateSet(DatePickerDialog view, int year, int month, int monthDay) {
            ...
            if (mView == mStartDateButton) {
                ...
                int yearDuration = endTime.jalaliYear - startTime.jalaliYear;
                int monthDuration = endTime.jalaliMonth - startTime.jalaliMonth;
                int monthDayDuration = endTime.jalaliMonthDay - startTime.jalaliMonthDay;

                startTime.jalaliYear = year;
                startTime.jalaliMonth = month;
                startTime.jalaliMonthDay = monthDay;
                startTime.jalaliToGregorian();
                startMillis = startTime.normalize(true);

                // Also update the end date to keep the duration constant.
                endTime.jalaliYear = year + yearDuration;
                endTime.jalaliMonth = month + monthDuration;
                endTime.jalaliMonthDay = monthDay + monthDayDuration;
                endTime.jalaliToGregorian();
                endMillis = endTime.normalize(true);
                ...
                startMillis = startTime.toMillis(true);
                endTime.jalaliYear = year;
                endTime.jalaliMonth = month;
                endTime.jalaliMonthDay = monthDay;
                endTime.jalaliToGregorian();
                endMillis = endTime.normalize(true);
...
//        private JalaliTime mTime;
//
//        public DateClickListener(JalaliTime time) {
//            mTime = time;
//        }
//
//        @Override
...
//            showDatePickerDialog(Utils.YEAR_MIN, Utils.YEAR_MAX, mTime.jalaliYear, mTime.jalaliMonth, mTime.jalaliMonthDay, listener);
//        }
//    }
    ...
    private class DateClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mDatePickerDialog = DatePickerDialog.newInstance(listener,
                    mTime.jalaliYear, mTime.jalaliMonth, mTime.jalaliMonthDay);
//            mDatePickerDialog.setFirstDayOfWeek(Utils.getFirstDayOfWeekAsCalendar(mActivity));
            mDatePickerDialog.setYearRange(Utils.YEAR_MIN, Utils.YEAR_MAX);
    ...
    public static class CalendarsAdapter extends ResourceCursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            CustomTextView name = (CustomTextView) view.findViewById(R.id.calendar_name);
            if (name != null) {
                String displayName = cursor.getString(nameColumn);
                name.setText(displayName);

                CustomTextView accountName = (CustomTextView) view.findViewById(R.id.account_name);
                if (accountName != null) {
                    accountName.setText(cursor.getString(ownerColumn));
                    accountName.setVisibility(CustomTextView.VISIBLE);
                }
            }
        }
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (dialog == mNoCalendarsDialog) {
            ...
            if (which == DialogInterface.BUTTON_POSITIVE) {
                ...
                final String[] array = {"com.yeksefr.khayam"};
    ...
    private boolean fillModelFromUI() {
        ...
        if (mModel.mAllDay) {
            ...
            mTimezone = JalaliTime.TIMEZONE_UTC;
            mStartTime.hour = 0;
            mStartTime.minute = 0;
            mStartTime.second = 0;
            mStartTime.timezone = mTimezone;
            ...
            final long normalizedEndTimeMillis =
                    mEndTime.normalize(true) + JalaliDateUtils.DAY_IN_MILLIS;
            if (normalizedEndTimeMillis < mModel.mStart) {
                // mEnd should be midnight of the next day of mStart.
                mModel.mEnd = mModel.mStart + JalaliDateUtils.DAY_IN_MILLIS;
            } else {
    ...
    public EditEventView(Activity activity, View view, EditDoneRunnable done,
        ...
        mLoadingMessage = (CustomTextView) view.findViewById(R.id.loading_message);
        ...
        mTimezoneLabel = (CustomTextView) view.findViewById(R.id.timezone_label);
        mStartDateButton = (Button) view.findViewById(R.id.start_date);
        mEndDateButton = (Button) view.findViewById(R.id.end_date);
        mWhenView = (CustomTextView) mView.findViewById(R.id.when);
        mTimezoneTextView = (CustomTextView) mView.findViewById(R.id.timezone_textView);
        ...
        mStartTimeHome = (CustomTextView) view.findViewById(R.id.start_time_home_tz);
        mStartDateHome = (CustomTextView) view.findViewById(R.id.start_date_home_tz);
        mEndTimeHome = (CustomTextView) view.findViewById(R.id.end_time_home_tz);
        mEndDateHome = (CustomTextView) view.findViewById(R.id.end_date_home_tz);
        ...
        mStartTime = new JalaliTime(mTimezone);
        mEndTime = new JalaliTime(mTimezone);
...
//        }
    ...
    private void prepareAvailability() {
        ...
        mAvailabilityAdapter = new ArrayAdapter<String>(mActivity,
               R.layout.custom_spinner_item, mAvailabilityLabels);
        mAvailabilityAdapter.setDropDownViewResource(R.layout.custom_spinner_dropdown_item);
    ...
    public void setModel(CalendarEventModel model) {
        ...
        if (model.mIsOrganizer || TextUtils.isEmpty(model.mOrganizer)
            ...
            ((CustomTextView) mView.findViewById(R.id.organizer)).setText(model.mOrganizerDisplayName);
        }
        ...
        if (model.mUri != null) {
            ...
            CustomTextView tv = (CustomTextView) mView.findViewById(R.id.calendar_textview);
            tv.setText(model.mCalendarDisplayName);
            tv = (CustomTextView) mView.findViewById(R.id.calendar_textview_secondary);
            if (tv != null) {
    ...
    private void addFieldsRecursive(StringBuilder b, View v) {
        ...
        if (v instanceof CustomTextView) {
            CharSequence tv = ((CustomTextView) v).getText();
    ...
    protected void setWhenString() {
        ...
        String tz = mTimezone;
        if (mModel.mAllDay) {
            flags |= JalaliDateUtils.FORMAT_SHOW_WEEKDAY;
            tz = JalaliTime.TIMEZONE_UTC;
        } else {
    ...
    private void setDate(TextView view, long millis) {
        int flags = JalaliDateUtils.FORMAT_SHOW_DATE | JalaliDateUtils.FORMAT_SHOW_YEAR
                | JalaliDateUtils.FORMAT_SHOW_WEEKDAY | JalaliDateUtils.FORMAT_ABBREV_MONTH
                | JalaliDateUtils.FORMAT_ABBREV_WEEKDAY;
        ...
        synchronized (TimeZone.class) {
            ...
            dateString = JalaliDateUtils.formatDateTime(mActivity, millis, flags);
    ...
    private void setTime(TextView view, long millis) {
        ...
        flags |= JalaliDateUtils.FORMAT_CAP_NOON_MIDNIGHT;
        if (DateFormat.is24HourFormat(mActivity)) {
            flags |= JalaliDateUtils.FORMAT_24HOUR;
        }
        ...
        synchronized (TimeZone.class) {
            TimeZone.setDefault(TimeZone.getTimeZone(mTimezone));
            timeString = JalaliDateUtils.formatDateTime(mActivity, millis, flags);
            TimeZone.setDefault(null);
        }
    ...
    private void updateHomeTime() {
        ...
        if (!mAllDayCheckBox.isChecked() && !TextUtils.equals(tz, mTimezone)
            ...
            mSB.setLength(0);
            time.append(JalaliDateUtils
                    .formatDateRange(mActivity, mF, millisStart, millisStart, flags, tz))
                    .append(" ").append(tzDisplay);
            mStartTimeHome.setText(time.toString());

            flags = JalaliDateUtils.FORMAT_ABBREV_ALL | JalaliDateUtils.FORMAT_SHOW_DATE
                    | JalaliDateUtils.FORMAT_SHOW_YEAR | JalaliDateUtils.FORMAT_SHOW_WEEKDAY;
            mSB.setLength(0);
            mStartDateHome
                    .setText(JalaliDateUtils.formatDateRange(
            ...
            time.setLength(0);
            mSB.setLength(0);
            time.append(JalaliDateUtils.formatDateRange(
            ...
            flags = JalaliDateUtils.FORMAT_ABBREV_ALL | JalaliDateUtils.FORMAT_SHOW_DATE
                    | JalaliDateUtils.FORMAT_SHOW_YEAR | JalaliDateUtils.FORMAT_SHOW_WEEKDAY;
            mSB.setLength(0);
            mEndDateHome.setText(JalaliDateUtils.formatDateRange(
...
//    public void onDateListener(int year, int month, int monthDay)
//    {
//    	myDateListener.onDateSet(null, year, month, monthDay);
//    }
//    
//    public void onTimeListener(int hourOfDay, int minute)
//    {
//    	myTimeListener.onTimeSet(null, hourOfDay, minute);
//    }
//    
//    DateListener myDateListener;
//    TimeListener myTimeListener;
//    private void showDatePickerDialog(int min, int max, int year, int month, int day, DateListener listener)
//    {
//    	mShowTimeDate = true;
//    	myDateListener = listener;
//    	
//    	Intent intent = new Intent("com.yeksefr.action.PICK_DATE");
...
//    }
//    
//    private void showTimePickerDialog(int hour, int minute, TimeListener listener)
//    {
//    	mShowTimeDate = true;
//    	myTimeListener = listener;
//    	
//    	Intent intent = new Intent("com.yeksefr.action.PICK_TIME");
//    	Bundle bundle = new Bundle();
//    	bundle.putInt("hour", hour);
//    	bundle.putInt("minute", minute);
//    	bundle.putBoolean("is24hour", DateFormat.is24HourFormat(mActivity));
//    	intent.putExtras(bundle);
//    	
