...
import com.yeksefr.khayam.DeleteEventHelper;
                ...
                if ((mCode & Utils.DONE_SAVE) != 0) {
                    if (mActivity != null) {
                        ...
                        if (mModel.mAllDay) {
                            ...
                            JalaliTime t = new JalaliTime(JalaliTime.TIMEZONE_UTC);
                            t.set(start);
                            t.timezone = tz;
                            start = t.toMillis(true);

                            t.timezone = JalaliTime.TIMEZONE_UTC;
                            t.set(end);
                            t.timezone = tz;
                            end = t.toMillis(true);
                        }
...
//			if (requestCode == 1)
//			{
//				mView.setShowTimeDate(false);
//		    	Bundle bundle = data.getExtras();
//		    	int year = bundle.getInt("year");
//		    	int monthOfYear = bundle.getInt("month");
//		    	int dayOfMonth = bundle.getInt("day");
//		    	
//		    	mView.onDateListener(year, monthOfYear, dayOfMonth);
//		    	
//			} else if (requestCode == 2)
//			{
//				mView.setShowTimeDate(false);
//				Bundle bundle = data.getExtras();
//				int hourOfDay = bundle.getInt("hour");
//				int minute = bundle.getInt("minute");
//				mView.onTimeListener(hourOfDay, minute);
//			}
//		}
//    }
}