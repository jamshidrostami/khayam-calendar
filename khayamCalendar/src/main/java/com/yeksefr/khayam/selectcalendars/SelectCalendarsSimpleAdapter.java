...
package com.yeksefr.khayam.selectcalendars;
...
import com.yeksefr.khayam.CalendarColorPickerDialog;
import com.yeksefr.khayam.CustomTextView;
import com.yeksefr.khayam.Utils;
import com.yeksefr.khayam.selectcalendars.CalendarColorCache.OnCalendarColorsLoadedListener;
...
public class SelectCalendarsSimpleAdapter extends BaseAdapter implements ListAdapter,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        CustomTextView calendarName = (CustomTextView) view.findViewById(R.id.calendar);
        ...
        if (syncCheckBox != null) {
            ...
            CustomTextView secondaryText = (CustomTextView) view.findViewById(R.id.status);
