...
import com.yeksefr.khayam.AllInOneActivity;
...
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    private void performUpdate(Context context,
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            // Calendar header
            JalaliTime time = new JalaliTime(Utils.getTimeZone(context, null));
            time.setToNow();
            long millis = time.toMillis(true);
            final String dayOfWeek = JalaliDateUtils.getDayOfWeekString(context, time.weekDay,
            		JalaliDateUtils.LENGTH_LONG);
            final String date = JalaliDateUtils.formatDateRange(context, millis, millis,
            		JalaliDateUtils.FORMAT_ABBREV_ALL | JalaliDateUtils.FORMAT_SHOW_DATE
                            | JalaliDateUtils.FORMAT_NO_YEAR);
