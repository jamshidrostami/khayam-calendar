...
import com.yeksefr.khayam.selectcalendars.SelectVisibleCalendarsActivity;
...
public class CalendarController {
    ...
    private final JalaliTime mTime = new JalaliTime();
    ...
    public static class EventInfo {
        ...
        public JalaliTime selectedTime; // the selected time in focus
        ...
        public JalaliTime startTime;
        public JalaliTime endTime;
    ...
    public void sendEventRelatedEventWithExtraWithTitleWithCalendarId(Object sender, long eventType,
        ...
        info.id = eventId;
        info.startTime = new JalaliTime(Utils.getTimeZone(mContext, mUpdateTimezone));
        info.startTime.set(startMillis);
        if (selectedMillis != -1) {
            info.selectedTime = new JalaliTime(Utils.getTimeZone(mContext, mUpdateTimezone));
            info.selectedTime.set(selectedMillis);
        } else {
            info.selectedTime = info.startTime;
        }
        info.endTime = new JalaliTime(Utils.getTimeZone(mContext, mUpdateTimezone));
     ...
     */
    public void sendEvent(Object sender, long eventType, JalaliTime start, JalaliTime end, long eventId,
            int viewType) {
    ...
    public void sendEvent(Object sender, long eventType, JalaliTime start, JalaliTime end, JalaliTime selected,
