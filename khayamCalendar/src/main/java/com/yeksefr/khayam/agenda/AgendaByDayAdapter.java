...
import com.yeksefr.khayam.agenda.AgendaWindowAdapter.DayAdapterInfo;
...
public class AgendaByDayAdapter extends BaseAdapter {
    ...
    private final Runnable mTZUpdater = new Runnable() {
        ...
        public void run() {
            ...
            mTmpTime = new JalaliTime(mTimeZone);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row.mType == TYPE_DAY) {
            ...
            if (holder == null) {
                ...
                holder.dayView = (CustomTextView) agendaDayView.findViewById(R.id.day);
                holder.dateView = (CustomTextView) agendaDayView.findViewById(R.id.date);
                holder.julianDay = row.mDay;
                holder.grayed = false;
            ...
            String dateViewText = JalaliDateUtils.formatDateRange(mContext, mFormatter, millis, millis,
            ...
            CustomTextView title = holder.title;
    ...
    public void calculateDays(DayAdapterInfo dayAdapterInfo) {
        ...
        JalaliTime tempTime = new JalaliTime(mTimeZone);
        long now = System.currentTimeMillis();
        tempTime.set(now);
        mTodayJulianDay = JalaliTime.getJulianDay(now, tempTime.gmtoff);
     ...
     */
    public int findEventPositionNearestTime(JalaliTime time, long id) {
        if (mRowInfo == null) {
            return 0;
        }
