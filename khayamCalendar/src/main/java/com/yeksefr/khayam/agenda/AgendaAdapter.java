...
import com.yeksefr.khayam.ColorChipView;
...
public class AgendaAdapter extends ResourceCursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (holder == null) {
            ...
            view.setTag(holder);
            holder.title = (CustomTextView) view.findViewById(R.id.title);
            holder.when = (CustomTextView) view.findViewById(R.id.when);
            holder.where = (CustomTextView) view.findViewById(R.id.where);
        ...
        CustomTextView when = holder.when;
        CustomTextView where = holder.where;
        ...
        if (allDay) {
            tzString = JalaliTime.TIMEZONE_UTC;
        } else {
        ...
        whenString = JalaliDateUtils.formatDateRange(context, mFormatter, begin, end, flags, tzString)
                .toString();
        if (!allDay && !TextUtils.equals(tzString, eventTz)) {
            String displayName;
            // Figure out if this is in DST
            JalaliTime date = new JalaliTime(tzString);
            date.set(begin);
    ...
    public static void updateReminder(View view, Context context, long begin, long eventId) {
        ...
        if (remindersCursor != null) {
            ...
            while (remindersCursor.moveToNext()) {
                ...
                CustomTextView reminderItemText = (CustomTextView) reminderItem.findViewById(R.id.reminder);
