...
import com.yeksefr.khayam.agenda.AgendaAdapter.ViewHolder;
import com.yeksefr.khayam.agenda.AgendaWindowAdapter.AgendaItem;
...
public class AgendaListView extends ListView implements OnItemClickListener {
    ...
    private void initView(Context context) {
        ...
        mTime = new JalaliTime(mTimeZone);
    ...
    private boolean updatePastEvents() {
        ...
        time.set(now);
        int todayJulianDay = JalaliTime.getJulianDay(now, time.gmtoff);
    ...
    public void goTo(JalaliTime time, long id, String searchQuery, boolean forced,
    ...
    public boolean isAgendaItemVisible(JalaliTime startTime, long id) {
    ...
    private void shiftPosition(int offset) {
        ...
        if (firstVisibleItem != null) {
            ...
            if (DEBUG) {
                ...
                } else if (firstVisibleItem instanceof CustomTextView) {
