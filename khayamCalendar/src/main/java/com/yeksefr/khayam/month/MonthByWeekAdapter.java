...
public class MonthByWeekAdapter extends SimpleWeeksAdapter {
    ...
    protected JalaliTime mTempTime;
    protected JalaliTime mToday;
    ...
    protected void init() {
        ...
        mToday = new JalaliTime(mHomeTimeZone);
        mToday.setToNow();
        mTempTime = new JalaliTime(mHomeTimeZone);
    }
    ...
    @Override
    protected void onDayTapped(JalaliTime day) {
    ...
    private void setDayParameters(JalaliTime day) {
        day.timezone = mHomeTimeZone;
        JalaliTime currTime = new JalaliTime(mHomeTimeZone);
    ...
    protected class CalendarGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
            if (mLongClickedView != null) {
                JalaliTime day = mLongClickedView.getDayFromLocation(mClickedXLocation);
                if (day != null) {
    ...
    private final Runnable mDoSingleTapUp = new Runnable() {
        ...
        public void run() {
            if (mSingleTapUpView != null) {
                JalaliTime day = mSingleTapUpView.getDayFromLocation(mClickedXLocation);
                if (Log.isLoggable(TAG, Log.DEBUG)) {
