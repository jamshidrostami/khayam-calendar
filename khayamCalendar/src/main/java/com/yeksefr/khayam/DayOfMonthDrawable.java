...
public class DayOfMonthDrawable extends Drawable {
    ...
    public DayOfMonthDrawable(Context c) {
        ...
        mPaint.setTypeface(CustomFont.droidnaskhBold);
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawText(Helper.convertEnglishNumbersToParsi(mDayOfMonth), bounds.right / 2, ((float) bounds.bottom + textHeight + 1) / 2,
                mPaint);
    }
