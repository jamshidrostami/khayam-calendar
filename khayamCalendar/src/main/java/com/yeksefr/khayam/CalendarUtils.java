...
public class CalendarUtils {
    ...
    public static class TimeZoneUtils {
        ...
        private volatile static String mHomeTZ = JalaliTime.getCurrentTimezone();
        ...
        public String formatDateRange(Context context, long startMillis,
            ...
            String date;
            String tz;
            if ((flags & JalaliDateUtils.FORMAT_UTC) != 0) {
            ...
            synchronized (mSB) {
                mSB.setLength(0);
                date = JalaliDateUtils.formatDateRange(context, mF, startMillis, endMillis, flags,
                        tz).toString();
            }
            return date;
        }
        ...
        public String getTimeZone(Context context, Runnable callback) {
            synchronized (mTZCallbacks){
                if (mFirstTZRequest) {
                    ...
                    mHomeTZ = prefs.getString(KEY_HOME_TZ, JalaliTime.getCurrentTimezone());
            ...
            return mUseHomeTZ ? mHomeTZ : JalaliTime.getCurrentTimezone();
        }
