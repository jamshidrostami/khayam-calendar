...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAmText = getActivity().getString(R.string.am);
        mPmText = getActivity().getString(R.string.pm);
    ...
    private void setHour(int value, boolean announce) {
        ...
        CharSequence text = Helper.convertEnglishNumbersToParsi(String.format(format, value));
    ...
    private void setMinute(int value) {
        ...
        CharSequence text = Helper.convertEnglishNumbersToParsi(String.format(Locale.getDefault(), "%02d", value));
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            String hourStr = Helper.convertEnglishNumbersToParsi((values[0] == -1)? mDoublePlaceholderText :
                String.format(hourFormat, values[0]).replace(' ', mPlaceholderText));
            String minuteStr = Helper.convertEnglishNumbersToParsi((values[1] == -1)? mDoublePlaceholderText :
