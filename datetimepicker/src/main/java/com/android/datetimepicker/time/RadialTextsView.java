...
//        mTypefaceRegular = Typeface.create(typefaceFamilyRegular, Typeface.NORMAL);
    ...
    public void onDraw(Canvas canvas) {
        ...
        drawTexts(canvas, mTextSize, CustomFont.droidnaskh, mTexts, mTextGridWidths, mTextGridHeights);
        if (mHasInnerCircle) {
            drawTexts(canvas, mInnerTextSize, CustomFont.droidnaskhBold, mInnerTexts,
    ...
    private void drawTexts(Canvas canvas, float textSize, Typeface typeface, String[] texts,
        ...
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[0]), textGridWidths[3], textGridHeights[0], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[1]), textGridWidths[4], textGridHeights[1], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[2]), textGridWidths[5], textGridHeights[2], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[3]), textGridWidths[6], textGridHeights[3], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[4]), textGridWidths[5], textGridHeights[4], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[5]), textGridWidths[4], textGridHeights[5], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[6]), textGridWidths[3], textGridHeights[6], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[7]), textGridWidths[2], textGridHeights[5], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[8]), textGridWidths[1], textGridHeights[4], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[9]), textGridWidths[0], textGridHeights[3], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[10]), textGridWidths[1], textGridHeights[2], mPaint);
        canvas.drawText(Helper.convertEnglishNumbersToParsi(texts[11]), textGridWidths[2], textGridHeights[1], mPaint);
    }
