...
public abstract class MonthAdapter extends BaseAdapter implements OnDayClickListener {
    ...
    public static class CalendarDay {
        ...
        public CalendarDay(JalaliTime calendar) {
            year = calendar.jalaliYear;
            month = calendar.jalaliMonth;
            day = calendar.jalaliMonthDay;
        }
        ...
        private void setTime(long timeInMillis) {
            ...
            year = time.jalaliYear;
            month = time.jalaliMonth;
            day = time.jalaliMonthDay;
        }
    }
